					...
					{currentStep === 1 && (
						<Card>
							...
							<View className="space-y-5">
								<TextInput value={firstName} onChangeText={setFirstName} icon={<User />} label="First Name" placeholder="Juan" />
								<TextInput value={middleName} onChangeText={setMiddleName} label="Middle Name" placeholder="Dalisay" />
								<TextInput value={lastName} onChangeText={setLastName} label="Last Name" placeholder="Dela Cruz" />
								<TextInput value={address} onChangeText={setAddress} icon={<Home />} label="Address" placeholder="Barangay, City, Province" />
								<TextInput value={email} onChangeText={setEmail} icon={<Mail />} label="Email/Phone" placeholder="you@example.com" />
								<TextInput
									value={password}
