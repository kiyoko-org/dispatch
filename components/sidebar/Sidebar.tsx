				...
				<View className="mb-6">
					...
					{navigationItems
						...
						.map(item => (
							<TouchableOpacity
								key={item.id}
								className={`flex-row items-center px-3 py-3 rounded-lg mb-2 ${activeRoute === item.id
							...
							>
								...
								/>
								<Text
									className={`ml-3 font-medium ${activeRoute === item.id ? 'text-blue-600' : 'text-gray-700'
										}`}
								>
									{item.label}
								</Text>
